...
assert(home.includes('Alternate a11y route'), 'Expected homepage to list the alternate a11y route')
assert(home.indexOf('Reference version') < home.indexOf('Alternate a11y route'), 'Expected alternate a11y route to appear underneath the reference version')
assert(home.indexOf('Alternate a11y route') < home.indexOf('Variation version'), 'Expected alternate a11y route to appear before the variation version')
assert(home.includes('Case info sits above the secondary navigation and does not include tags or custody time limit.'), 'Expected alternate a11y route to duplicate the reference version description')
