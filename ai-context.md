  ...
  <div class="govuk-grid-row">
    <div class="govuk-grid-column-two-thirds">
      ...
      <p class="govuk-!-margin-bottom-7">
        {{ govukTag({ text: "February 2026", classes: "govuk-tag--grey govuk-!-margin-right-1" }) }}
        {{ govukTag({ text: "Alpha", classes: "govuk-tag--right-1" }) }}
        {{ govukTag({ text: "Tested in R1", classes: "govuk-tag--yellow" }) }}
      </p>
...
<h1 class="govuk-heading-l">Another section</h1>
```
...
When a prototype includes links to pages that haven't been created yet, link them to a shared placeholder page at `/not-yet-built`.
